...
class Run {
    ...
    def static void main(String[] args) {
        ...
        //println( reasoner.getInterpretations(solution as ModelResult))
    ...
    def private static loadMetamodel() {
        val pckg = CyberPhysicalSystemPackage.eINSTANCE
    ...
    def private static loadQueries(EcoreMetamodelDescriptor metamodel) { 
        val i = cpsgen.patterns.Pattern.instance
